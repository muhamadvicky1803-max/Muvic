document.addEventListener('DOMContentLoaded', () => {
    ...
    const galleryData = [
        {
            text: "Ini waktu pertama kali kita jalan bareng.. inget ngga? Kamu salting terus aku juga sebenernya salting parah hehehe 🙈💖",
            img: "https://images.unsplash.com/photo-1511895426328-dc8714191300?q=80&w=400&auto=format&fit=crop"
        },
        {
            text: "Kalo ini pas kita makan es krim! Liat deh muka kamu belepotan tapi tetep aja keliatan maniss banget di mata aku 🥺🍦💕",
